...
import { TIME_IN_MILLISECONDS } from '../../utils/time-enum.js';
...
export default class Logs extends AuthenticatedCommand {
    ...
    async run() {
        ...
        const logsFilterCriteria = await this.getLogsFilterCriteria(eventSource, flags.logsStartDate, flags.logsEndDate, flags.logSearchFromText);
        const args = {
            appVersionId,
            logsType,
            logsFilterCriteria,
