...
function validateIfValueIsANumber(input, message, isRequired = false) {
    if (isRequired && !input) {
        return message;
    }
...
export const PromptService = {
    ...
    async promptInput(message, required = false) {
        const res = await inquirer.prompt([
            {
                name: 'input',
    ...
    async promptInputNumber(message, required = false) {
        const res = await inquirer.prompt([
            {
                name: 'input',
                message: message || 'Please enter value',
