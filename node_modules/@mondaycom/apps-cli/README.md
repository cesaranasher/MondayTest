...
running command...
$ mapps (--version)
@mondaycom/apps-cli/1.3.4 linux-x64 node-v18.12.1
$ mapps --help [COMMAND]
USAGE
  $ mapps COMMAND
...
...
_See code: [src/commands/app-version/builds.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/app-version/builds.ts)_
...
_See code: [src/commands/app-version/list.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/app-version/list.ts)_
...
_See code: [src/commands/app/list.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/app/list.ts)_
...
_See code: [src/commands/code/env.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/code/env.ts)_
...
_See code: [src/commands/code/logs.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/code/logs.ts)_
...
```
USAGE
  $ mapps code:push [--verbose] [--print-command] [-d <value>] [-a <value>] [-i <value>]
...
_See code: [src/commands/code/push.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/code/push.ts)_
...
_See code: [src/commands/code/status.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/code/status.ts)_
...
_See code: [src/commands/init/index.ts](https://github.com/mondaycom/monday-code-cli/blob/v1.3.4/src/commands/init/index.ts)_
<!-- commandsstop -->
