...
var getToken = function (token, options) {
    if (options === void 0) { options = {}; }
    var selectedToken = options.token || token;
    if (!(0, guards_1.isDefined)(selectedToken)) {
        throw new apps_sdk_error_1.BadRequestError('Missing token');
    }
    return selectedToken;
};
var generateCrudPath = function (key, options) {
    if (!(0, guards_1.isDefined)(key)) {
        throw new apps_sdk_error_1.BadRequestError('Missing key');
    }
    var shared = options.shared;
    var storageUrl = getStorageUrl();
    // eslint-disable-next-line @typescript-eslint/restrict-template-expressions
    var fullPath = "".concat(storageUrl, "/").concat(key, "?shareGlobally=").concat(!!shared);
    return fullPath;
};
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                token = getToken(initToken, externalOptions);
                stringifiedBody = JSON.stringify(body);
                url = generateCrudPath(key, externalOptions);
...
var Storage = /** @class */ (function () {
    ...
    Storage.prototype["delete"] = function (key, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, storageFetch(key, this.token, options, { method: 'DELETE' })];
                    case 1:
                        _a.sent();
    ...
    Storage.prototype.get = function (key, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, storageFetch(key, this.token, options, { method: 'GET' })];
                    case 1:
                        result = _a.sent();
    ...
    Storage.prototype.set = function (key, value, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var previousVersion, result, version;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        previousVersion = options.previousVersion;
                        return [4 /*yield*/, storageFetch(key, this.token, options, {
                                method: 'POST',
                                body: __assign({ 
