    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!(0, guards_1.isDefined)(path)) {
                    throw new apps_sdk_error_1.BadRequestError('`path` must be provided');
                }
            ...
            case 4:
                ...
                if (!(0, guards_1.isDefined)(result.data)) {
...
var generateCrudPath = function (path, id) {
    var secureStorageAddress = (0, env_1.getMondayCodeContext)().secureStorageAddress;
    if (!(0, guards_1.isDefined)(path)) {
        throw new apps_sdk_error_1.BadRequestError('Missing secret key');
    }
    if (!(0, guards_1.isDefined)(id)) {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, fetch_wrapper_1.fetchWrapper)(loginUrl, {
                        method: 'POST',
                        body: body,
            ...
            case 1:
                ...
                if (!(0, guards_1.isDefined)(loginResponse)) {
                    logger.warn('[getToken] invalid gcp login response');
                    throw new apps_sdk_error_1.InternalServerError('An error occurred while authenticating');
                }
...
var getTokenExpiry = function (connectionData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                if (!(0, guards_1.isDefined)(response)) {
                    throw new apps_sdk_error_1.InternalServerError('An error occurred while authenticating');
                }
...
var getConnectionData = function (connectionData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, gcp_1.getGcpConnectionData)()];
            case 1:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!(0, guards_1.isDefined)(connectionData)) {
                    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                    // @ts-ignore
                    connectionData = {};
                }
                _a = connectionData;
                return [4 /*yield*/, (0, gcp_1.getGcpIdentityToken)(connectionData === null || connectionData === void 0 ? void 0 : connectionData.identityToken)];
            case 1:
                _a.identityToken = _b.sent();
                if (!!(0, guards_1.isDefined)(connectionData.token)) return [3 /*break*/, 3];
            ...
            case 3:
                ...
                tokenTtlInHours = ((new Date(expireTime)).getTime() - (new Date()).getTime()) / time_enum_1.TIME_IN_MILLISECOND.HOUR;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.connectionData = _b.sent();
                        fullPath = generateCrudPath(key, this.connectionData.id);
                        formalizedValue = (0, validations_1.isObject)(value) ? value : { value: value };
